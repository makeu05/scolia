...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:root,admin,directeur')->group(function () {
        ...
        Route::patch('/eleves/{matricule}/archiver',  [EleveController::class, 'archiver']);   // FIX: routes manquantes
        Route::patch('/eleves/{matricule}/reactiver', [EleveController::class, 'reactiver']);  // FIX: routes manquantes

        // Enseignants
        Route::apiResource('enseignants', EnseignantController::class);
        Route::patch('/enseignants/{id}/desactiver', [EnseignantController::class, 'desactiver']);
        Route::patch('/enseignants/{id}/reactiver',  [EnseignantController::class, 'reactiver']);
    ...
    // ── GESTION UTILISATEURS (root + admin uniquement) ────────────────────────
    Route::middleware('role:root,admin')->prefix('admin')->group(function () {
