...
=======
  ...
  { id: "enseignants",    label: "Enseignants",            icon: Users,           section: "gestion",   path: "/enseignants",     roles: ["root","admin","directeur"] },
  { id: "structure",      label: "Structure pédagogique",  icon: BookOpen,        section: "gestion",   path: "/cours",           roles: ["root","admin","directeur"] },
  ...
  { id: "annees",         label: "Années académiques",     icon: GraduationCap,   section: "gestion",   path: "/annees",          roles: ["root","admin"] },
  { id: "classes",        label: "Classes et cycles",      icon: GraduationCap,   section: "gestion",   path: "/classes",         roles: ["root","admin","directeur"] },
  { id: "salles",         label: "Salles de classe",       icon: GraduationCap,   section: "gestion",   path: "/salles",          roles: ["root","admin","directeur"] },
  { id: "scolarites",     label: "Scolarités",             icon: CreditCard,      section: "gestion",   path: "/scolarites",      roles: ["root","admin","fondateur"] },
  { id: "finance",        label: "Finances",               icon: CreditCard,      section: "gestion",   path: "/finance",         roles: ["root","admin","directeur","fondateur"] },
  { id: "paiements-stats",label: "Stats paiements",        icon: BarChart2,       section: "gestion",   path: "/paiements/stats", roles: ["root","admin","directeur","fondateur"] },
>>>>>>> origin/natanael
];
