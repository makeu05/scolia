...
import { ArrowLeft, Save, User, Phone, Heart, ChevronDown } from "lucide-react";
...
export default function EleveForm() {
  ...
  try {
    ...
    Object.entries(form).forEach(([k, v]) => {
      // ✅ En édition : envoyer tous les champs même vides
      // En création : ignorer seulement idAdmin si vide
      if (isEditing) {
        fd.append(k, v);          // ← envoyer même les chaînes vides
      } else {
        if (v !== '') fd.append(k, v);
      }
    });
