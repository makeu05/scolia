// src/pages/eleves/EleveDetails.tsx
...
import {
  ...
  User, Droplets, AlertTriangle, CheckCircle,
} from "lucide-react";
          ...
          <div className="flex items-center gap-5">
            <div className="w-20 h-20 rounded-2xl overflow-hidden bg-slate-100 flex-shrink-0">
              {getPhotoUrl(eleve.photoURL) ? (
                <img src={getPhotoUrl(eleve.photoURL)!} alt={eleve.nom} className="w-full h-full object-cover" />
              ) : (
                  ...
                  <div key={a.idScolariteAnt} className="card p-5 space-y-4">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <input
                          ref={bulletinRef} type="file" accept=".pdf,.jpg,.jpeg,.png" className="hidden"
